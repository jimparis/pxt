...
declare namespace pxt {
    ...
    interface AppTheme {
        ...
        // One image/card, or several images/cards to alternate between on full page loads.
        homeScreenHero?: string | CodeCard | (string | CodeCard)[];
        ...
        githubUrl?: string;
        usbDocs?: string;
        linuxUdevRulesUrl?: string;
        linuxUdevRulesFileName?: string;
